        ...
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav text-uppercase">
                    <li><a href="/">Записи блога</a></li>
                    <li><a href="/profile">Профиль</a></li>
                    <li><a href="/posts-list">Мои посты</a></li>
                </ul>
...
<footer class="footer-widget-section">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="address">
                        ...
                        <p>Украина, Краматорск</p>
                        <p>Phone: +380 000 00000</p>
                        <p>blog@blog.com</p>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2019 <a href="#"></a>Blog</div>
                </div>
            </div>
        </div> 
    </div>
